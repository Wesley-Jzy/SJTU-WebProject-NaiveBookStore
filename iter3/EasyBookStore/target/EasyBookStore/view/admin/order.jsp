...
<div class="container" align="center">
    <table id="dg" title="订单信息" class="easyui-datagrid" style="width:1100px;height:670px"
        ...
        <tr>
            ...
            <th field="createTime" width="150" editor="{type:'validatebox',options:{required:true}}">创建时间</th>
            <th field="status" width="100" editor="{type:'validatebox',options:{required:true}}"
            data-options="formatter: showOrderStatus">订单状态</th>
            <th data-options="field:'orderItems', width:180, formatter: showDetails">订单详情</th>
            <!--
...
<script type="text/javascript">
    ...
    function showOrderStatus(value,row, index) {
        if (row.status == 2) {
            return "已处理";
        }
    ...
    function showDetails(value, row, index) {
        var url = 'orderItem?order_id=' + row.id;
